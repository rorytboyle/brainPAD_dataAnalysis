function [probSigIn2, timesSigIn2] = replicatedByChanceIn2(x_1, x_2,...
    y_1, y_2, z_1, z_2, type, rows, iterations, p_1, p_2)
...
%              controlling for z_2
% OUTPUT:
% percentSigIn2 = double containing the percentage of iterations in which
%                 the pvalues from random partial correlations were <
%                 actual pvalues from real data in both datasets

% Authors: Rory Boyle & Rob Whelan - rorytboyle@gmail.com
% Date: 10/10/18
% Update: 01/11/18 - Edited code to calculate number of iterations where all
...
% significant finding in 2 datasets instead of percentage. 
...
timesSigIn2=sum(all(sort_null_pvals<actual_pvals,2));

% calculate and return p-value representing probability of replicating 
% findings by chance
probSigIn2 = timesSigIn2/iterations;
end
